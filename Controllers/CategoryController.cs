...
public class CategoryController : ControllerBase
{
    ...
    public ActionResult<category> DeleteCategory(int id)
    {
     ...
     // ฟังก์ชันสำหรับการ Update ให้  status = 0 ข้อมูล Category
    //   ทดสอบ update2/api/Category/1
    // update2/api/Category/1
        // ค้นหาข้อมูล Category ตาม ID
           [HttpPut("update2{id}")]
    public ActionResult<category> update2Category(int id)
    {
        ...
        // ลบข้อมูล Category
        cat.categorystatus = 0 ; // update category set categorystatus = '...' where id = 1
        _context.SaveChanges(); // commit
